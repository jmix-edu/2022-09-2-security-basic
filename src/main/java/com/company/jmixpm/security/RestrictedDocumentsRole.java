...
@RowLevelRole(name = "Restricted project documents by user", code="restricted-documents")
public interface RestrictedDocumentsRole {

    @JpqlRowLevelPolicy(entityClass = Document.class, join = "join {E}.project proj",
